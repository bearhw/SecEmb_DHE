...
def inference(
    ...
    print('best acc before ', best_acc_test)
...
def run():
    ...
    print('\n\n\n    DEBUG          ', len(train_ld), len(train_data), len(test_ld), len(test_data), '  \n\n\n ')
        ...
        if not args.inference_only:
            ...
            while k < args.nepochs:
                ...
                for j, inputBatch in enumerate(train_ld):
                    ...
                    # print('    DEBUG           ', X.shape, len(lS_o), len(lS_i))
