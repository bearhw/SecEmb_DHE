...
def parse_configurations():
    ...
    # parser.add_argument('--table-sizes', type=str, default='10-100-1000-10000-100000-1000000-5000000', help='Embedding table sizes')
    parser.add_argument('--table-sizes', type=str, default='10-100-1000', help='Embedding table sizes')
    ...
    # DHE Arguments
    parser.add_argument('--dhe-activation', type=str, default='relu', help='DHE Decoder MLP Activation Function')
    ...
    # C++ Ext
    parser.add_argument('--ext-type', type=str, default='undefined', help='Embedding Ext Type')

    # Select options
    parser.add_argument('--table-size-threshold', type=int, default=5000, help='')

    # DHE type
    parser.add_argument('--dhe-varying', action="store_true", default=False, help='')
