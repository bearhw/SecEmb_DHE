...
class DLRM(nn.Module):
    ...
    def apply_embedding_tables(self, offsets, indices, tables):
        ...
        for i in range(len(indices)):
            ...
            # print('EXT EMBEDDING EXECUTED output ', embedding.shape)
    ...
    def __init__(
        ...
        self.embedding_tables, self.tables_size = self.create_embedding_tables(self.emb_dim, self.table_sizes, self.precision,   ext_type)
