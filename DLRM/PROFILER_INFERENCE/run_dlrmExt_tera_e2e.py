...
table_size_rows = 100    if f is None else int(f) 
assert table_size_rows >= 1

f = os.environ.get('BATCH_SIZE') 
batch_size = 32    if f is None else int(f) 
assert batch_size >= 1
...
if __name__ == '__main__':
    ...
    tableSizes_list = ['10-10-10-14-36-61-101-122-970-1442-2208-7112-7378-11156-12420-17217-20134-36084-313829-415421-1333352-7267859-9758201-9946608-9980333-9994222'] # small fix for ZT
    mlp_bot_dims_str =  "13-512-256-" #-64
