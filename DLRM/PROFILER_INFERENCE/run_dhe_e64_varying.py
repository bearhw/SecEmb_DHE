...
if __name__ == '__main__':
    ...
    # dheK_list = [ 2048 ]
    dheK_list = [ 1024, 896, 768, 640, 512, 384, 256, 128 ]

    dheMLP_list = [ "512-256", "448-224", "384-192", "320-160", "256-128", "192-96", "128-64", "64-64" ] #          e64
    # dheMLP_list = [ "512-256", "448-224", "384-192", "320-160", "256-128", "192-96", "128-64", "64-32" ] #          e16
        ...
        for tableSizes in tableSizes_list:
            ...
            for embSize in embSize_list:
                ...
                for numLookups in numLookups_list:
                    ...
                    for dheK, dheMLP in zip(dheK_list, dheMLP_list):
                       ...
                       # args.dhe_mlp_dims = str(dheK)+"-128-"+str(embSize)
                        args.dhe_mlp_dims = str(dheK)+"-"+dheMLP+"-"+str(embSize)
