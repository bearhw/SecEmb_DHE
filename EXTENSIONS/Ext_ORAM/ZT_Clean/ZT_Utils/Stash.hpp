  ...
  #include "Globals_Enclave.hpp"
	...
	class Stash{
		...
		public:
			...
			void PerformAccessOperation2(char opType, uint32_t id, uint32_t position_in_id, uint32_t newleaf, uint32_t newleaf_nextlevel, uint32_t* nextLeaf, uint32_t recursion_stash_size);
