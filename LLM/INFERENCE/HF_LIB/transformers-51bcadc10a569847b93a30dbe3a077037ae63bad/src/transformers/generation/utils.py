    ...
    def _greedy_search(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            # import Argmax_Ext ## custom
            # next_tokens = Argmax_Ext.forward(next_tokens_scores)
            
            ### print('ARGMAX', next_tokens_scores.shape, next_tokens_scores.dtype, next_tokens.shape, next_tokens.dtype)
